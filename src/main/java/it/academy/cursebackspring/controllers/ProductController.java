...
public class ProductController {
    ...
    @GetMapping()
    public ResponseEntity<ProductDTO> getProductById(@PathVariable(value = "productId") Long id) {
        ProductDTO productDTO = productService.getProductById(id);
        return ResponseEntity.ok(productDTO);
    }

    @GetMapping("/reviews")
    public ResponseEntity<ReviewsDTO> getProductReviewsById(@PathVariable(value = "productId") Long id, GetReviewsDTO dto) {
        dto.setProductId(id);
    ...
    public ResponseEntity<?> createNewReview(@PathVariable(value = "productId") Long id, @RequestBody CreateReviewDTO dto) {
        dto.setProductId(id);
    ...
    public ResponseEntity<?> getUserReviewOnProduct(@PathVariable(value = "productId") Long productId) {
    ...
    public ResponseEntity<?> deleteReview(@PathVariable(value = "productId") Long productId) {
        Long userId = ((User) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getId();
